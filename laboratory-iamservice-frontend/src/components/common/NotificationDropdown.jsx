...
const NotificationDropdown = ({ items = [] }) => {
    ...
    items.push({
      label: (
        <span className='flex flex-col items-center'>
          ...
          <span className='absolute bottom-5 pl-2 font-bold'>No incomming notification</span>
        </span>
      ),
      key: "0"
    })
  ...
  return (
    <Dropdown
      ...
      className="hover:cursor-pointer hover:scale-110 transition-all duration-300 ease-in-out text-[#888]">
      <IoIosNotifications style={{ fontSize: "22px", marginTop: "1px" }} />
    </Dropdown>
  )
}
